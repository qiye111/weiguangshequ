package com.shichao.auth.service;

import lombok.RequiredArgsConstructor;
import com.shichao.auth.api.dto.AuthResponse;
import com.shichao.auth.api.dto.AuthUserResponse;
import com.shichao.auth.api.dto.LoginRequest;
import com.shichao.auth.api.dto.PasswordResetRequest;
import com.shichao.auth.api.dto.RegisterRequest;
import com.shichao.auth.api.dto.SendCodeRequest;
import com.shichao.auth.api.dto.SendCodeResponse;
import com.shichao.auth.api.dto.TokenRefreshRequest;
import com.shichao.auth.api.dto.TokenResponse;
import com.shichao.auth.audit.LoginLogService;
import com.shichao.auth.config.AuthProperties;
import com.shichao.common.exception.BusinessException;
import com.shichao.common.exception.ErrorCode;
import com.shichao.auth.model.ClientInfo;
import com.shichao.auth.model.IdentifierType;
import com.shichao.auth.token.JwtService;
import com.shichao.auth.token.RefreshTokenStore;
import com.shichao.auth.token.TokenPair;
import com.shichao.user.domain.User;
import com.shichao.user.service.UserService;
import com.shichao.auth.util.IdentifierValidator;
import com.shichao.auth.verification.SendCodeResult;
import com.shichao.auth.verification.VerificationCheckResult;
import com.shichao.auth.verification.VerificationCodeStatus;
import com.shichao.auth.verification.VerificationScene;
import com.shichao.auth.verification.VerificationService;
...
public class AuthService {
    ...
    public AuthResponse register(RegisterRequest request, ClientInfo clientInfo) {
        ...
        User user = User.builder()
                ...
                .avatar("https://static.weiguang.cn/default-avatar.png")
                .bio(null)
                .tagsJson("[]")
                .build();
    ...
    private String generateNickname() {
        return "微光用户" + UUID.randomUUID().toString().substring(0, 8);
    }
